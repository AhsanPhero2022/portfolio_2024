...
const SheetContent = React.forwardRef(
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-8 top-8 rounded-sm opacity-70 ring-offset-accent transition-opacity hover:opacity-100 disabled:pointer-events-none">
